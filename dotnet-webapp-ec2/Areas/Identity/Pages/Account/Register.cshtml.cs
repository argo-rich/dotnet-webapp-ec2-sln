...
namespace dotnet_webapp_ec2.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// <summary>
            /// This is added by Rich Argo for the Northwind webapp to represent the user's First Name
            /// </summary>
            [Required]
            ...
            /// <summary>
            /// This is added by Rich Argo for the Northwind webapp to represent the user's Last Name
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "The {0} must be at max {1} characters long.")]
            [DataType(DataType.Text)]
